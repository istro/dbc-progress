...
describe Flashcard::Game do
  ...
  it "prints instructions when the game starts" # do
  #     STDOUT.should_receive(:puts).with("Type study if you want to study cards card.\nType guess if you want to practice.\nType exit if you're done.")
  #   end
  ...
  it "runs in 'study' mode as expected until you type stop"
    # @new_game.study('stop').should == "Type study if you want to study cards card.\nType guess if you want to practice.\nType exit if you're done."
